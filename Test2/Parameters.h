...
const double Sq_MaxX = 100000;
const double Sq_MinY = 0;
const double Sq_MaxY = 100000;
...
const double Xgridmin = Sq_MinX + HRSize1;
const double Ygridmin = Sq_MinY + HRSize1;
const double Xspace = (Sq_MaxX - Sq_MinX - 2*HRSize1)/(MaxNoX+1);
const double Yspace = (Sq_MaxY - Sq_MinY - 2*HRSize1)/(MaxNoY+1);
