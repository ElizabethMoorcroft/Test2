...
const double LengthMonitoring = 140*24*(60*60); //Length of monitoring in seconds. XX*(60*60)secs => XX hrs
...
const double StepLength = 12*60*60; //Length of each step in seconds
