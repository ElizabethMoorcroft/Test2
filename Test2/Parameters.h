...
const int NoOfIterations = 5; // No of iterations with the settings

//Random number seed
const int Seed =1; // initail start seed - becuase this is set makes result repilicable

// Length of simulation
const double LengthMonitoring = 60*60;//100*24*(60*60); //Length of monitoring in seconds. XX*(60*60)secs => XX hrs
...
// Sensor width/Radius
const int LengthSW(4);
const double SensorWidth[LengthSW] = {05*M_PI/180,45*M_PI/180,90*M_PI/180,180*M_PI/180};
...
const double CorrWalkMaxAngleChange = 90*M_PI/180; // In Radians. Half width. X°= X*pi/180rads
